...
class LoginForm extends React.Component {
  ...
  handleChange = event => {
    // event.target.name is the input's name attibute name="username"
    // event.target.value is the input value attribute value={this.state.username}
    this.setState({
  ...
  handleSubmit = event => {
    ...
    // if username is false or not password then return function that will console.log()
